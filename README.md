...
### 📊 Детали маршрута
![Детали маршрута](screenshots/hike_detail.png)
*Подробная информация о маршруте: погода, парковка, отзывы и рекомендации*

### 🌤️ Погодная аналитика
![Погодный график](screenshots/weather_chart.png)
*Прогноз погоды на 12 часов с визуализацией температуры и осадков*

### 🗺️ Форма добавления маршрута
![Добавление маршрута](screenshots/add_hike.png)
